  ...
  return (
    <Loading isLoading={isLoading || loading}>
      ...
      <div className='body' style={{ width: '100%', backgroundColor: '#ececec', }}>
        <div id="container" style={{ minHeight: '1000px', width: '1270px', margin: '0 auto', paddingBottom: '20px', backgroundColor: '#ffffff' }}>
          <SliderComponent arrImages={[slider4, slider5, slider6, slider7]} />
          <WrapperProducts>
