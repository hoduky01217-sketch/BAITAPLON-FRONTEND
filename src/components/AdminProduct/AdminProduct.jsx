...
const AdminProduct = () => {
  ...
  const fetchGetDetailsProduct = async (rowSelected) => {
    try {
      ...
      // ignore, drawer keeps default values
    }
          ...
          >
            ...
            <Form.Item
              ...
              rules={[
                ...
                { pattern: /^\d+$/, message: 'Count inStock must be a number!' }
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                ...
                { pattern: /^\d+(\.\d+)?$/, message: 'Price must be a number!' }
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                ...
                { pattern: /^\d+(\.\d+)?$/, message: 'Rating must be a number!' },
                { validator: (_, value) => (value === undefined || value === '' || (Number(value) >= 0 && Number(value) <= 5)) ? Promise.resolve() : Promise.reject('Rating must be between 0 and 5!') }
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                ...
                { pattern: /^\d+(\.\d+)?$/, message: 'Discount must be a number!' },
                { validator: (_, value) => (value === undefined || value === '' || (Number(value) >= 0 && Number(value) <= 100)) ? Promise.resolve() : Promise.reject('Discount must be between 0 and 100!') }
              ]}
            >
            ...
            <Form.Item
              ...
              name="images"
            >
              <WrapperUploadFile onChange={handleOnchangeImages} maxCount={6} multiple listType="picture-card">
        ...
        <Loading isLoading={isLoadingUpdate || isLoadingUpdated}>
          ...
          >
            ...
            <Form.Item
              ...
              name="images"
            >
              <WrapperUploadFile onChange={handleOnchangeImagesDetails} maxCount={6} multiple listType="picture-card">
                <Button>Select Files</Button>
              </WrapperUploadFile>
            </Form.Item>
            <Form.Item wrapperCol={{ offset: 20, span: 16 }}>
